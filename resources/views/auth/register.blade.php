      ...
      <div class="tab-content">
        ...
        <div id="signup">   
          ...
          <form action="{{ route('register') }}" method="POST">
            ...
            <div class="field-wrap">
              ...
              @if($errors->has('name'))
                        ...
                        @foreach($errors->get('name') as $error)
                             <span id="name-error" class="form-text text-danger">
                                * {{$error}}
                             </span>
                        @endforeach
            ...
            <div class="field-wrap" >
              <select name="gender"  style="background-color:#14232f;font-size: 20px;">
               ...
               @if($errors->has('gender'))
                        ...
                        @foreach($errors->get('gender') as $error)
                             <span id="gender-error" class="form-text text-danger">
                                * {{$error}}
                             </span>
                        @endforeach
          ...
          <div class="field-wrap">
            ...
            <input id="password-confirm" required name="password_confirmation" type="password"  autocomplete="off"/>
          </div>

          
          <button type="submit" class="button button-block" style="cursor:pointer"/>Register</button>
