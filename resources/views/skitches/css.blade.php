...
<body>
	<textarea name="code" id="cssEditor"></textarea>
</body>
...
<script>
	...
	var css = '<?= json_encode(json_decode($skitch->code)->css) ?>' ; 


	var codeArea = document.querySelector('#cssEditor');

	css = css.slice(1,css.length-1); 

	codeArea.innerHTML = css;
